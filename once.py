...
# if the char in that string is not in utf-8 format it will convert that string into a garbage value
...
print "saving pickled_algos/documents.pickle......"
...
print "saving pickled_algos/word_features5k.pickle......"
